 ...
 * 
 */
@WebServiceClient(name = "VendaWsService", targetNamespace = "http://webservices.cella/", wsdlLocation = "http://localhost:8085/lab148352/VendaWs?wsdl")
    ...
    extends Service
{
    ...
    private final static QName VENDAWSSERVICE_QNAME = new QName("http://webservices.cella/", "VendaWsService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8085/lab148352/VendaWs?wsdl");
    ...
    public VendaWs getVendaWsPort() {
        return super.getPort(new QName("http://webservices.cella/", "VendaWsPort"), VendaWs.class);
    }
    ...
    public VendaWs getVendaWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.cella/", "VendaWsPort"), VendaWs.class, features);
    }
