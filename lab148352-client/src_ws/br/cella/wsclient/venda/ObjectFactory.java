 ...
 * generated in the br.cella.wsclient.venda package. 
...
public class ObjectFactory {
    ...
    private final static QName _OperacaoVenda_QNAME = new QName("http://webservices.cella/", "operacaoVenda");
    private final static QName _OperacaoVendaResponse_QNAME = new QName("http://webservices.cella/", "operacaoVendaResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.cella.wsclient.venda
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices.cella/", name = "operacaoVenda")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices.cella/", name = "operacaoVendaResponse")
